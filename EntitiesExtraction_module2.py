...
def best_Match_resume(data, skills_list):
    ...
    def _skill(data):
        ...
        col=['Skill','Date','NORP','Languages','Name']
        ...
        # def entities():
        ruler.from_disk(r"E:\Waseem\extraViz\spacy\jz_skill_patterns.jsonl") 
        skills=[]
        phone=[]
        Loc=[]
        org=[]
        ...
        #             print(ent.text)
            ...
            new_data1=new_data1.append({'Skill':skills,'Date':phone,'NORP':norp,'Languages':language,'summary':summary}, ignore_index=True)
